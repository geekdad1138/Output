SambaNova and Intel are working on another development looking to break the mold on how we use AI, not just all GPUs. Not going to lie, I had to ask my AI buddy what an RDU is.

In the wonderful poetic and fun words of Gemini:
- An RDU is like a professional sushi chef with a custom-built, infinite conveyor belt.
- The CPU is a home cook following a recipe book: he has to keep stopping to read the next step, find the salt, and chop one onion at a time.
